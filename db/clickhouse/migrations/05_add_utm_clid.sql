-- Create Event
CREATE TABLE superlytics.website_event_new
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
-- stats hourly
CREATE TABLE superlytics.website_event_stats_hourly_new
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
CREATE MATERIALIZED VIEW superlytics.website_event_stats_hourly_mv_new
TO superlytics.website_event_stats_hourly_new
AS
SELECT
    website_id,
    session_id,
...
FROM superlytics.website_event_new
GROUP BY website_id,
    session_id,
    visit_id,
    hostname,
...
-- projections
ALTER TABLE superlytics.website_event_new
ADD PROJECTION website_event_url_path_projection (
SELECT * ORDER BY toStartOfDay(created_at), website_id, url_path, created_at
);

ALTER TABLE superlytics.website_event_new MATERIALIZE PROJECTION website_event_url_path_projection;
...
ALTER TABLE superlytics.website_event_new MATERIALIZE PROJECTION website_event_referrer_domain_projection;

-- migration
INSERT INTO superlytics.website_event_new
...
FROM superlytics.website_event

-- rename tables
RENAME TABLE superlytics.website_event TO superlytics.website_event_old;
RENAME TABLE superlytics.website_event_new TO superlytics.website_event;

RENAME TABLE superlytics.website_event_stats_hourly TO superlytics.website_event_stats_hourly_old;
RENAME TABLE superlytics.website_event_stats_hourly_new TO superlytics.website_event_stats_hourly;

RENAME TABLE superlytics.website_event_stats_hourly_mv TO superlytics.website_event_stats_hourly_mv_old;
RENAME TABLE superlytics.website_event_stats_hourly_mv_new TO superlytics.website_event_stats_hourly_mv;

-- recreate view
DROP TABLE superlytics.website_event_stats_hourly_mv;

CREATE MATERIALIZED VIEW superlytics.website_event_stats_hourly_mv
TO superlytics.website_event_stats_hourly
AS
SELECT
    website_id,
    session_id,
