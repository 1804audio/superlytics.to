...
CREATE TABLE "usage_record" (
    ...
    CONSTRAINT "usage_record_pkey" PRIMARY KEY ("usage_record_id")
);

-- CreateTable
CREATE TABLE "appsumo_code" (
    "appsumo_code_id" UUID NOT NULL,
    ...
    CONSTRAINT "appsumo_code_pkey" PRIMARY KEY ("appsumo_code_id")
);
...
CREATE TABLE "auth_token" (
    ...
    CONSTRAINT "auth_token_pkey" PRIMARY KEY ("token_id")
);
...
-- CreateIndex
CREATE INDEX "user_subscription_id_idx" ON "user"("subscription_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "usage_record_usage_record_id_key" ON "usage_record"("usage_record_id");

-- CreateIndex
CREATE UNIQUE INDEX "usage_record_userId_month_key" ON "usage_record"("user_id", "month");

-- CreateIndex
CREATE INDEX "usage_record_user_id_idx" ON "usage_record"("user_id");

-- CreateIndex
CREATE INDEX "usage_record_month_idx" ON "usage_record"("month");

-- CreateIndex
CREATE INDEX "usage_record_year_idx" ON "usage_record"("year");

-- CreateIndex
CREATE UNIQUE INDEX "appsumo_code_appsumo_code_id_key" ON "appsumo_code"("appsumo_code_id");

-- CreateIndex
CREATE UNIQUE INDEX "appsumo_code_code_key" ON "appsumo_code"("code");

-- CreateIndex
CREATE INDEX "appsumo_code_code_idx" ON "appsumo_code"("code");

-- CreateIndex
CREATE INDEX "appsumo_code_plan_id_idx" ON "appsumo_code"("plan_id");

-- CreateIndex
CREATE INDEX "appsumo_code_is_used_idx" ON "appsumo_code"("is_used");

-- CreateIndex
CREATE UNIQUE INDEX "auth_token_token_id_key" ON "auth_token"("token_id");
...
-- CreateIndex
CREATE INDEX "auth_token_type_idx" ON "auth_token"("type");
